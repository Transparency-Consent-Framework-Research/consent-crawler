    ...
    async (crawlingContext) => {
        ...
        try {
            ...
            const gppData = await page.evaluate(() =>
                new Promise((resolve) => window.__gpp('ping', (data, success) => resolve(success ? data : null)))
            );
        ...
        try {
            ...
            const uspData = await page.evaluate(() =>
                new Promise((resolve) => window.__uspapi('getUSPData', 1, (data, success) => resolve(success ? data : null)))
            );
