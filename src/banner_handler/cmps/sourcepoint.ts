  ...
  variants: [
    {
      ...
      check: async(page: Page) => {
        ...
        return !!(await iframe.locator('button[title="Reject all"],button[title="Reject All"],button[title="Reject cookies"],button[title="No, I Do Not Accept"],button[title="No, thank you"],button[title="Essential cookies only"],button[title="Essential Cookies Only"]').count());}
      ...
      reject: async (page: Page) => {
        const iframe = page.frameLocator('iframe[title="SP Consent Message"]');
        await iframe.locator('button[title="Reject all"],button[title="Reject All"],button[title="Reject cookies"],button[title="No, I Do Not Accept"],button[title="No, thank you"],button[title="Essential cookies only"],button[title="Essential Cookies Only"]').click();
